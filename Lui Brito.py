...
'''
#adicionei hour, minutes e n a função .format()
'''
#'Questão 2'
...
'''
#adicionei as variáveis ao .format
'''
...
'''
#adicionei as variáveis e o 'float(input())' para que o código faça a média corretamente.
'''
#'Questão 4'
...
'''
#corrigi o texto 'vaIue' para value.
'''
#'Questão 5'
...
'''
#adicionei  a < b no if para que o erro termine. 
'''
#'Questão 7'
...
'''
#corrigi colocando elif e else deixado o código mais limpo.
'''
#'Questão 8'
...
for i in range (0,n):
    ...
    if i > 0:
        ...
        print('NULL')
'''
#corrigi o sinal de = que estava apenas = mas o ideal é ==
'''
#'Questão 9'
